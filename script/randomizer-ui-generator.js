class RandomizerUiGenerator {
    ...
    _generateSurvivorItemAddonsElements(item) {
        ...
        $('#survivor .item-addon-image').each(function() {
            ...
            for(let i = 0; i < addons.length; i++) {
                ...
                $(this).append(self.createDivElement('item-addon', [
        ...
        $('#' + role + ' .offer-image').each(function() {
            ...
            offers.forEach(function(offering) {
                $(offerImage).append(self._createDivElement('offer', [
                    ...
                    RandomizerUrlBuilder.buildCssOfferingBackPatch(offering.rarity)
                ]));
            });
        });
    }
    ...
    _generateKillerPortraitElements() {
        this._generateKillerPortraitElements('#killer .portrait-image', 'killer', ROLES[0], KILLERS);
    }

    _generateSurvivorPortraitElements() {
        this._generateKillerPortraitElements('#survivor .portrait-image', 'survivor', ROLES[1], SURVIVORS);
    }
    ...
    _buildBakcgroundImages(backgroundImages) {
        let result = '';
